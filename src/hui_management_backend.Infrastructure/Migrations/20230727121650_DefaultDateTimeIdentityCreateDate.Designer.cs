...
namespace hui_management_backend.Infrastructure.Migrations
{
    ...
    [Migration("20230727121650_DefaultDateTimeIdentityCreateDate")]
    partial class DefaultDateTimeIdentityCreateDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UserUser", b =>
                {
                    ...
                    b.HasKey("CreateById", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserCreateBy", (string)null);
                });
            ...
            modelBuilder.Entity("hui_management_backend.Core.UserAggregate.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("IdentityCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 7, 27, 19, 16, 50, 102, DateTimeKind.Unspecified).AddTicks(2674), new TimeSpan(0, 7, 0, 0, 0)));
