...
namespace hui_management_backend.Infrastructure.Migrations
{
    ...
    [Migration("20230811123753_FundSessionCOntainFundBills")]
    partial class FundSessionCOntainFundBills
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hui_management_backend.Core.UserAggregate.SubUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("IdentityCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 8, 11, 19, 37, 53, 915, DateTimeKind.Unspecified).AddTicks(3264), new TimeSpan(0, 7, 0, 0, 0)));
