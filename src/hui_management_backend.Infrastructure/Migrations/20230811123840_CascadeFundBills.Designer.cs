...
namespace hui_management_backend.Infrastructure.Migrations
{
    ...
    [Migration("20230811123840_CascadeFundBills")]
    partial class CascadeFundBills
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hui_management_backend.Core.UserAggregate.SubUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("IdentityCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 8, 11, 19, 38, 40, 250, DateTimeKind.Unspecified).AddTicks(6365), new TimeSpan(0, 7, 0, 0, 0)));
