...
namespace hui_management_backend.Infrastructure.Migrations
{
    ...
    [Migration("20230811124912_CascadePaymentFundBill")]
    partial class CascadePaymentFundBill
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hui_management_backend.Core.UserAggregate.SubUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("IdentityCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 8, 11, 19, 49, 12, 872, DateTimeKind.Unspecified).AddTicks(9525), new TimeSpan(0, 7, 0, 0, 0)));
