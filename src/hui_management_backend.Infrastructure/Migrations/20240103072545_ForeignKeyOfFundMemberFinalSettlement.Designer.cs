...
namespace hui_management_backend.Infrastructure.Migrations
{
    ...
    [Migration("20240103072545_ForeignKeyOfFundMemberFinalSettlement")]
    partial class ForeignKeyOfFundMemberFinalSettlement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hui_management_backend.Core.FundAggregate.FundMember", b =>
                {
                    ...
                    b.HasIndex("finalSettlementForDeadSessionBillId")
                        .IsUnique()
                        .HasFilter("[finalSettlementForDeadSessionBillId] IS NOT NULL");
            ...
            modelBuilder.Entity("hui_management_backend.Core.UserAggregate.SubUser", b =>
                {
                    ...
                    b.Property<DateTime>("IdentityCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 1, 3, 14, 25, 45, 175, DateTimeKind.Local).AddTicks(7660));
            ...
            modelBuilder.Entity("hui_management_backend.Core.FundAggregate.FundMember", b =>
                {
                    ...
                    b.HasOne("hui_management_backend.Core.PaymentAggregate.Payment", "finalSettlementForDeadSessionBill")
                        .WithOne()
                        .HasForeignKey("hui_management_backend.Core.FundAggregate.FundMember", "finalSettlementForDeadSessionBillId")
                        .OnDelete(DeleteBehavior.Cascade);
