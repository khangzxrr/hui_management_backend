...
public static class SeedData
{
  ...
  public static readonly Fund Fund = new Fund("Hụi ngày", 1, 1, 0, DateTime.Now , DateTime.Now, DateTime.Now, 1500000.0, 300000.0, FundType.DayFund);
